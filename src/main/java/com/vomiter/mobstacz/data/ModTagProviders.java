package com.vomiter.mobstacz.data;

import com.vomiter.mobstacz.Helpers;
...
public class ModTagProviders {
    ...
    class BlockTags extends BlockTagsProvider{
        ...
        public BlockTags() {
            super(output, lookupProvider, MobsTacz.MOD_ID, helper);
        }
    ...
    class ItemTags extends ItemTagsProvider {
        public ItemTags(BlockTags blockTags) {
            super(output, lookupProvider, blockTags.contentsGetter(), MobsTacz.MOD_ID, helper);
        }
